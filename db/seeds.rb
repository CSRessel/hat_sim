...
Server.create(name: 'Engineer's RP Server - PST', address: '138.8.81.149:65', map: 'pl_hydro', password: 'pa55w0rd', dedicated: 'false', game: 'unspecified', players: '15', maxplayers '15', region: 'PST')
...
Server.create(name: 'Carl's Prophunt Server - CST', address: '168.231.125.193:123', map: 'ph_pipeline', password: 'pasphrase', dedicated: 'false', game: 'unspecified', players: '10', maxplayers '22', region: 'CST')
Server.create(name: 'Carl's Prophunt Server - PST', address: '26.148.159.192:250', map: 'arena_idle', password: 'pasword', dedicated: 'false', game: 'unspecified', players: '24', maxplayers '29', region: 'PST')
...
Server.create(name: 'Engineer's Server - EST', address: '75.64.227.42:197', map: 'mvm_hightower', password: 'password1234', dedicated: 'true', game: 'highlander', players: '17', maxplayers '18', region: 'EST')
Server.create(name: 'Bob's Server - EST', address: '143.123.178.194:185', map: 'ctf_idle', password: 'passw0rd', dedicated: 'true', game: 'unspecified', players: '12', maxplayers '17', region: 'EST')
Server.create(name: 'Carl's RP Server - CST', address: '54.71.62.58:89', map: 'mvm_steel', password: 'pessword', dedicated: 'true', game: 'unspecified', players: '15', maxplayers '15', region: 'CST')
Server.create(name: 'Bob's RP Server - EST', address: '134.248.250.48:159', map: 'pl_turbine', password: 'pesswerd', dedicated: 'false', game: 'unspecified', players: '9', maxplayers '19', region: 'EST')
Server.create(name: 'Carl's Prophunt Server - MST', address: '24.165.234.185:183', map: 'ph_steel', password: 'password', dedicated: 'true', game: 'unspecified', players: '19', maxplayers '29', region: 'MST')
...
Server.create(name: 'Bob's Server - PST', address: '200.169.3.121:1', map: 'mvm_turbine', password: 'pessphrase', dedicated: 'false', game: 'unspecified', players: '5', maxplayers '18', region: 'PST')
